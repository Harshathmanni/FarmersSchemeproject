...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=LAPTOP-UL9E6NOK\\SQLEXPRESS;Database=FarmerSchemeProject;Trusted_Connection=True;");
            }
        }*/
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<BankDetail>(entity =>
            {
                entity.HasKey(e => e.AccountNo)
                    .HasName("PK__BankDeta__349D9DFD04B9FE77");
                ...
                entity.HasOne(d => d.Email)
                    ...
                    .HasConstraintName("FK__BankDetai__Email__3B75D760");
            });

            modelBuilder.Entity<Bidding>(entity =>
            {
                entity.HasKey(e => e.BidderId)
                    .HasName("PK__Bidding__3D8E5339D706D09B");
                ...
                entity.HasOne(d => d.Sell)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__Bidding__SellID__49C3F6B7");
            });

            modelBuilder.Entity<ClaimInsurance>(entity =>
            {
                entity.HasKey(e => e.PolicyNo)
                    .HasName("PK__ClaimIns__2E132197E227FE8F");
            ...
            modelBuilder.Entity<CropTable>(entity =>
            {
                entity.HasKey(e => e.CropId)
                    .HasName("PK__CropTabl__923561355DD10D7E");
                ...
                entity.HasOne(d => d.Farmer)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__CropTable__Farme__46E78A0C");
            });
            ...
            modelBuilder.Entity<Insurance>(entity =>
            {
                ...
                entity.HasOne(d => d.PolicyNoNavigation)
                    ...
                    .HasConstraintName("FK__Insurance__Polic__534D60F1");

                entity.HasOne(d => d.User)
                    .WithMany(p => p.Insurances)
                    .HasForeignKey(d => d.UserId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__Insurance__UserI__52593CB8");
            });

            modelBuilder.Entity<LandDetail>(entity =>
            {
                entity.HasKey(e => e.FarmerId)
                    .HasName("PK__LandDeta__731B88E8677A9C7D");
                ...
                entity.HasOne(d => d.Email)
                    ...
                    .HasForeignKey(d => d.EmailId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__LandDetai__Email__3E52440B");
            });

            modelBuilder.Entity<Registration>(entity =>
            {
                entity.HasKey(e => e.EmailId)
                    .HasName("PK__Registra__7ED91AEF872D547F");
            ...
            modelBuilder.Entity<Roletable>(entity =>
            {
                entity.HasKey(e => e.UserId)
                    .HasName("PK__Roletabl__1788CCAC9EF6182D");
                ...
                entity.HasOne(d => d.Email)
                    ...
                    .HasForeignKey(d => d.EmailId)
                    .HasConstraintName("FK__Roletable__Email__38996AB5");
            });

            modelBuilder.Entity<SellCrop>(entity =>
            {
                entity.HasKey(e => e.SellId)
                    .HasName("PK__SellCrop__B35F66FF0D1B6445");
                ...
                entity.HasOne(d => d.Farmer)
                    ...
                    .HasForeignKey(d => d.FarmerId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__SellCrop__Farmer__412EB0B6");
            });

            modelBuilder.Entity<SoldHistory>(entity =>
            {
                entity.HasKey(e => e.Date)
                    .HasName("PK__SoldHist__77387D06C118E323");
                ...
                entity.HasOne(d => d.Sell)
                    ...
                    .HasForeignKey(d => d.SellId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__SoldHisto__SellI__440B1D61");
            });
